# :beer: Testes unitários para validar uma API REST :beers:  

Projeto apresentado pelo especialista [Rodrigo Peleias](https://www.linkedin.com/in/rodrigopeleias/) para demonstração de todo o processo
de desenvolvimento de testes unitários, utilizando como base os  testes em uma API REST de gerenciamento de estoques de uma cervejaria. 

A continuação deste README.md também foi feita pelo especialista, e por ser bastante informativa, pode 
